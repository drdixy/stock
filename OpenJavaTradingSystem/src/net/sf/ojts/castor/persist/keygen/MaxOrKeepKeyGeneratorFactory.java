 ...
 *
 */
public class MaxOrKeepKeyGeneratorFactory implements KeyGeneratorFactory {

    public KeyGenerator getKeyGenerator(PersistenceFactory factory, Properties arg1, int sql_type) throws MappingException {
        return new MaxOrKeepKeyGenerator( factory, sql_type );
    }
