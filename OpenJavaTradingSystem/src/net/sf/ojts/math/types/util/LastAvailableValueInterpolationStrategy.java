 ...
 *
 */
public class LastAvailableValueInterpolationStrategy implements InterpolationStrategy {
	...
	public LastAvailableValueInterpolationStrategy() {
		type_ = LAST_AVAILABLE_VALUE;
	}
	public LastAvailableValueInterpolationStrategy(int type) {
		type_ = type;
	}
