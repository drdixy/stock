 ...
 *
 */
package net.sf.ojts.math.types;
...
public interface DoubleSequence {
    ...
    public int getIndex();
    public Object getLabel(int index);// might be the index itself or a Date or ...

    public boolean hasNext();
    public double[] next();
    public double[] current();
    public Object getLabel();// might be the index itself or a Date or ...
    public int inc(); 
    public int dec();
    public void rewind();
