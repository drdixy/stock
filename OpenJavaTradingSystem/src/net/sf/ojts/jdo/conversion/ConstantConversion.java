 ...
 * @author cs
 *
 * @table ConstantConversion
 * @xml   ConstantConversion
 */
public class ConstantConversion extends TypeConversion {

    protected double factor = -1.0;
    
    public ConstantConversion() {
        super();
    }

    public ConstantConversion(Unit from, Unit to, double factor) {
        super(from, to);
        this.factor = factor;
    }    
